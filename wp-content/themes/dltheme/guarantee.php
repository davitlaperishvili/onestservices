...
<body >
  ...
  <section class="hero_inside">
    ...
    <div class="container">
      <div class="hero_content">
        <h1 class="page_title">Our Guarantee</h1>
  ...
  <section class="list_points no_bg">
    <div class="container">
      <h2 class="section_title center"><span>Our Guarantee</span></h2>
      <div class="section_subtitle center">At Onest Services we stand behind the quality of our services. We understand the importance of trust in our business, and we are committed to earning and maintaining the trust of our clients. Here's what we guarantee:</div>
      <div class="points_list box_shadow">
        <div class="point_item" style="box-shadow: 0 16px 40px rgba(194, 138, 86, 0.2);">
          <figure>
    ...
    <div class="container">
      <div class="banner_wrap">
        <div class="banner_content">
          <div class="banner_title">Choose Onest Services for your property management needs, and experience the difference that our guarantee can make.</div>
          <div class="theme_button">
            <a href="#">Contact Us</a>
          </div>
        </div>
