...
<body >
  ...
  <section class="hero_inside">
    ...
    <div class="container">
      <div class="hero_content">
        <h1 class="page_title">Comprehensive Day-to-Day Service</h1>
    ...
    <div class="container">
      <div class="block_wrap">
        <div class="block_content">
          <h2 class="section_title"><span>More space <br> for Paragraph</span></h2>
  ...
  <section class="list_points no_bg">
    <div class="container">
      ...
      <div class="section_subtitle center">Our team handles all the day-to-day activities involved in property services, serving as the primary point of contact between tenants, landlords, and contractors. This service includes:</div>
      ...
      <div class="section_note">This service ensures a smooth, efficient process for all parties involved, saving landlords time and stress.</div>
    </div>
  </section>
